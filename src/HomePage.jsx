    ...
    <div className="homepage">
      ...
      <nav className="navbar">
        <div className="nav-content">
          <div className="logo">Interior Design Studio</div>
          ...
          <div className="cta-grid">
            <div className="cta-content">
              ...
              <div className="cta-buttons">
                ...
                <button className="btn-cta-secondary">Schedule Consultation</button>
              </div>
            </div>
          ...
          <div className="footer-grid">
            ...
            <div className="footer-section">
              ...
              <ul className="footer-list">
                <li><a href="#" className="footer-link">Residential Design</a></li>
                <li><a href="#" className="footer-link">Commercial Spaces</a></li>
                <li><a href="#" className="footer-link">Space Planning</a></li>
                <li><a href="#" className="footer-link">3D Visualization</a></li>
              </ul>
            </div>
            <div className="footer-section">
